...
namespace Temp::Render
{
  ...
  {
    square.shaderProgram = OpenGLWrapper::CreateShaderProgram(OpenGLWrapper::vertexShaderSource, OpenGLWrapper::fragmentShaderSource);
    ...
    // -------------------------
    square.texture1 = OpenGLWrapper::LoadTexture("src/Engine/Images/container.jpg", GL_RGB);
    square.texture2 = OpenGLWrapper::LoadTexture("src/Engine/Images/awesomeface.png", GL_RGBA);
  ...
  {
    Font::LoadFont();
    cube.shaderProgram = OpenGLWrapper::CreateShaderProgram(OpenGLWrapper::vertexShaderSource, OpenGLWrapper::fragmentShaderSource);
    ...
    // load and create a texture
    // -------------------------
    cube.texture1 = OpenGLWrapper::LoadTexture("src/Engine/Images/container.jpg", GL_RGB);
    cube.texture2 = OpenGLWrapper::LoadTexture("src/Engine/Images/awesomeface.png", GL_RGBA);
