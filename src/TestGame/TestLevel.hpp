    ...
    namespace TestLevel
    {
                             ...
                             size_t &index)
      {
        ...
        std::cout << "Entity: "
                  << entity
                  << " Position: "
                  << Component::Container::Get<static_cast<uint8_t>(Component::Type::POSITION2D)>(data.coordinator.componentData, entity).x
                  << " "
                  << Component::Container::Get<static_cast<uint8_t>(Component::Type::POSITION2D)>(data.coordinator.componentData, entity).y
                  << std::endl;
        ++index;
